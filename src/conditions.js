...
export const CONDITIONS = [
  { id: 'clear', name: '☀️ Clear', fgMaxRange: 55, barSpeedMult: 1.0,  overlay: null,   unlock: 0 },
  { id: 'rain',  name: '🌧️ Rain',  fgMaxRange: 50, barSpeedMult: 1.25, overlay: 'rain', unlock: 26 },
  { id: 'wind',  name: '💨 Wind',  fgMaxRange: 38, barSpeedMult: 1.0,  overlay: 'wind', unlock: 27 },
  { id: 'snow',  name: '❄️ Snow',  fgMaxRange: 45, barSpeedMult: 1.1,  overlay: 'snow', unlock: 28 },
  { id: 'fog',   name: '🌫️ Fog',   fgMaxRange: 48, barSpeedMult: 1.15, overlay: 'fog',  unlock: 29 },
];
